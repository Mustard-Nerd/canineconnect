    ...
    <div className="min-h-screen">
      <div className="pl-4 sm:pl-[30px] xl:pl-[150px] 2xl:pl-[200px] flex justify-between items-end">
        <div className=" w-1/2 max-w-[570px]">
          ...
          <div className="shadow-custom py-[22px] px-[53px] w-full flex gap-3 items-center mb-[40px] mt-[140px] rounded-[10px] justify-between">
      ...
      <div className=" px-4 sm:px-[30px] xl:px-[150px] 2xl:px-[200px] mt-[68px] flex justify-between items-start gap-2">
        <div className="flex justify-center w-[33%] items-center flex-col gap-2">
          ...
          <div className="rounded-[10px] border-[#121212] border-[1px] px-[20px] pt-[35px] h-[220px]">
      ...
      <div className="mt-[90px]">
        ...
        <div className="grid grid-cols-2 h-full gap-[28px]">
          <div className="col-span-1 bg-[#121212] rounded-[15px] pl-[100px] pr-[42px] font-quicksand text-white pt-[40px]">
          ...
          <div className="col-span-1 sm:pr-[30px] xl:pr-[150px] 2xl:pr-[200px] pt-10 flex justify-center items-center flex-col pb-[64px]">
            ...
            <div className="w-full mt-[38px] font-quicksand font-[700] text-[15px] flex flex-col gap-[26px]">
              <fieldset className="flex flex-col items-start w-full gap-2">
                ...
                <input
                  type="text"
                  className="border-b-[1px] border-b-black outline-none px-4 bg-white w-full"
                />
              </fieldset>
              <fieldset className="flex flex-col items-start w-full gap-2">
              ...
              <fieldset className="flex flex-col items-start w-full gap-2">
                ...
                <textarea className="border-b-[1px] border-b-black outline-none px-4 bg-white w-full h-[200px]" />
              </fieldset>
            </div>
            <div className="mt-[40px] w-full flex justify-end ">
              <button className="font-quicksand h-10 rounded-[5px] px-[28px] bg-white border-secondary text-secondary border-[2px] text-[15px] font-[700]">
                Submit
              </button>
            </div>
          </div>
      ...
      <div className=" px-4 sm:px-[30px] xl:px-[150px] 2xl:px-[200px] mt-[96px] pb-10">
        ...
        <p className="text-center text-[#121212] text-[30px] font-quicksand my-[35px]">
        ...
        <div className="flex justify-center items-center gap-[185px]">
          <Button text="CHAT WITH US" className="w-[180px]" />
          <Button text="CONTACT US" className="w-[180px]" />
        </div>
      </div>
...
export const Questions = ({ question, answer }: QuestionProp) => {
  ...
  return (
    <div className="border-b-[1px] border-b-white py-[18px] w-full">
