  ...
  return (
    <div>
      ...
      <div className=" px-4 sm:px-[30px] xl:px-[150px] 2xl:px-[200px] base:-mt-36 xs:-mt-10   sm:mt-20 ">
        ...
        <div
          className={`flex lg:mt-[150px] lg:mb-28 my-28 sm:flex-row  flex-col items-center justify-between  gap-10 sm:gap-20 xl:gap-[150px]`}
        >
          <div className="flex flex-col items-center justify-center sm:items-start">
            ...
            <div className="font-quicksand pt-4 text-center sm:text-left font-normal text-[15px] lead-[24px] max-w-[480px]">
              Unleash your pup's full potential (and save your sanity!) with a
              professional dog trainer. Our trainers can help you address any
              behavior issues, from excessive barking to jumping, and teach your
              furry friend valuable commands.
            </div>
        ...
        <div>
          <div className=" font-benz text-[20px] sm:text-[30px] font-bold pb-4">
            Liscenesed dog adoption home in your location
          </div>
