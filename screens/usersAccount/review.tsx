  ...
  return (
    <ProfileLayout>
      ...
      {!accountDetails && !changePassword &&  !newsLetter &&
        <div>
          <div className="pb-6 font-benz font-[700] text-[24px] lg:text-[32px]">Account Overview</div>
          <div className=' grid lg:grid-cols-2 gap-10  grid-cols-1'>
            <div className=' border rounded-[13px] border-primary dark:border-white'>
                ...
                >
                  ...
                  <Image src="/menu/Editing.svg" alt="editing" width={40} height={40} className="lg:w-[40px] lg:h-[40px] w-[20px] h-[20px] " />
                </div>
                <div className='px-9 py-11 flex flex-col gap-4 '>
                  ...
                  <div className='flex flex-col gap-3'>
                    ...
                    <div  className='text-[16px]'>No 1, Ajalepaekun street lekki | Lagos </div>
                  </div>
                </div>
            </div>
            <div className=' border rounded-[13px] border-primary dark:border-white'>
                ...
                <div className='px-9 py-11  '>
                  <div className='text-[20px]'>You can change your password here</div>
                </div>
            </div>  
        ...
        <div>
          ...
          <div>
            <div className=" font-[600] text-[16px] lg:text-[20px] pb-5 lg:pb-2 border-b-2 border-primary dark:border-white text-center">
              ...
              Get the latest news, tips, and offers delivered straight to your inbox!
            </div>

            <div className=" lg:p-10 pt-4 lg:pt-10">
              <div  className=" font-[600] text-[16px] lg:text-[28px] pb-5 lg:pb-10" >Why Subscribe?</div>
              ...
              <div className=" font-[400] text-[18px] ">Join our community of dog lovers and never miss out on what's new at Canine Connect.</div>
            </div>
