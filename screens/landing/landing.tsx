  ...
  return (
    <div>
      ...
      <div className=" px-4 sm:px-[30px] xl:px-[150px] 2xl:px-[200px] base:-mt-44 xs:-mt-10 sm:mt-9 lg:mt-0 ">
        <div className=" font-benz text-[20px] sm:text-[30px] font-bold pb-4">Top selling Products</div>
          ...
          <div className=" flex flex-col sm:flex-row text-white justify-between items-center gap-10 mt-9">
            <div className="relative rounded-[10px] ">
              ...
              />
                ...
                <div className=" absolute inset-0 ml-10 top-16 sm:top-16 lg:top-28">
                  <div className=" font-quicksand font-bold text-[20px] lg:text-[30px]">Wet food</div>
                  <div className="mt-3  ">
            ...
            <div className="relative rounded-[10px]">
              ...
              />
                <div className="absolute inset-0 rounded-[10px] bg-[#242325] opacity-50 z-0"></div>
                <div className=" absolute inset-0 ml-10 top-16 sm:top-16 lg:top-28">
                  <div className=" font-quicksand font-bold text-[20px] lg:text-[30px]">Dry food</div>
                  <div className="mt-3  ">
                    <Button text="Shop now" href="/shop" />
                  </div>
                </div>
        ...
        <div>
          <div className=" font-benz text-[20px] sm:text-[30px] font-bold pb-4">Recommended Products</div>
