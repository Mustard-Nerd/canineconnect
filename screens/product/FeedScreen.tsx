                ...
                <div className="flex flex-col lg:flex-row gap-[24px] justify-between items-start w-full">
                  <div className="flex flex-col items-start">
                    ...
                    <div className="flex justify-start items-center gap-5 min-[1724px]:gap-10">
                      <p className="bg-[#B38100] w-[80px] min-[1724px]:w-[90px] h-[50px] min-[1724px]:h-[60px] text-center flex justify-center items-center rounded-[14px] min-[1724px]:text-[32px] text-[24px] font-[850] font-benz text-black">
                        250g
                      </p>
                      <p className="border-[#004A8C] border-[1px] w-[80px] min-[1724px]:w-[900px] h-[50px] min-[1724px]:h-[60px] text-center flex justify-center items-center rounded-[14px] min-[1724px]:text-[32px] text-[24px] font-[850] font-benz">
                        500g
                      </p>
                      <p className="border-[#004A8C] border-[1px] w-[80px] min-[1724px]:w-[900px] h-[50px] min-[1724px]:h-[60px] text-center flex justify-center items-center rounded-[14px] min-[1724px]:text-[32px] text-[24px] font-[850] font-benz">
                        1kg
