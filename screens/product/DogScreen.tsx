          ...
          <div className="col-span-1 flex flex-col justify-between">
            ...
            <div>
              ...
              <div className="flex items-start gap-4 flex-col mt-[24px]">
                ...
                <div className="dark:bg-white bg-primary h-[1px] w-full my-1 hidden lg:block"></div>
            ...
            <div className="pt-[30px] min-[1724px]:pt-[40px] lg:flex justify-between items-start gap-2 w-full hidden">
